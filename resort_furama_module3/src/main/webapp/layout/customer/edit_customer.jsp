            ...
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="name" value="${customer.getName()}" style="width:500px"></td>
                    </tr>
                    <tr>
                        <td>Ngày sinh</td>
                        <td><input type="date" name="dateOfBirth" value="${customer.getDateOfBirth()}" style="width:500px"></td>
                    </tr>
                    <tr>
                        <td>Giới tính</td>
                    ...
                    <tr>
                        <td>CMND</td>
                        <td><input type="text" name="idCard" value="${customer.getIdCard()}" style="width:500px"></td>
                    </tr>
                    <tr>
                        <td>Số điện thoại</td>
                        <td><input type="text" name="phone" value="${customer.getPhoneNumber()}" style="width:500px"></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><input type="text" name="email" value="${customer. getEmail()}" style="width:500px"></td>
                    </tr>
                    <tr>
                        <td>Địa chỉ</td>
                        <td><input type="text" name="address" value="${customer.getAddress()}" style="width:500px"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td>
