        ...
        <div>
            <table class="table table-primary table-info border-danger border-secondary table-hover table-striped " id="tableEmployee">
                ...
                <c:forEach var="employee" items="${employeeList}">
                    <tr>
                        <td><a href="/Customer?action=view&id=${customer.getId()}">${employee.getId()}</a></td>
                        ...
                        <td>${employee.getEducation().getNameEducation()}</td>
                        <td>${employee.getDivision().getNameDivision()}</td>

                        <td><a href="/Customer?action=edit&id=${customer.getId()}" class="btn btn-outline-secondary">Edit</a>
                        </td>
