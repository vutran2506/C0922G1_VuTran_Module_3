...
select  hd.ma_hop_dong, nv.ho_ten as ten_nhan_vien , kh.ho_ten as ten_khach_hang , kh.so_dien_thoai as so_dien_thoai_khach_hang,
 dv.ten_dich_vu  , sum(hdct.so_luong),  hd.tien_dat_coc from hop_dong hd 
...
select hdct.ma_hop_dong, ldv.ten_loai_dich_vu ,dvdk.ten_dich_vu_di_kem , sum(hdct.so_luong) as so_luong_dich_vu_di_kem from dich_vu_di_kem dvdk
join hop_dong_chi_tiet hdct on hdct.ma_dich_vu_di_kem = dvdk.ma_dich_vu_di_kem
...
select nv.ma_nhan_vien, nv.ho_ten, td.ten_trinh_do,bp.ten_bo_phan, nv.so_dien_thoai, nv.dia_chi, count(hd.ma_hop_dong) from nhan_vien nv
